...
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-estrutura-da-celula-procariota-e-eucariota';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-membrana-plasmatica-e-transporte-difusao-osmose-transporte-a';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-organelas-mitocondria-reticulo-endoplasmatico-golgi-lisossom';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-nucleo-e-organizacao-do-material-genetico';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-ciclo-celular-interfase-mitose-meiose';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'biologia-biologia-celular-e-molecular-controle-do-ciclo-celular-e-apoptose';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-estrutura-atomica-e-modelos-atomicos';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-tabela-periodica-e-propriedades-periodicas';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-ligacoes-quimicas-ionica-covalente-metalica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-geometria-molecular-e-polaridade';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-forcas-intermoleculares';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-funcoes-inorganicas-acidos-bases-sais-oxidos';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-reacoes-quimicas-e-balanceamento';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-estequiometria';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-solucoes-concentracao-diluicao-solubilidade';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-termoquimica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-cinetica-quimica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-equilibrio-quimico';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-eletroquimica-pilhas-e-eletrolise';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'quimica-quimica-geral-acidos-e-bases-teorias-ph-e-poh';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'fisica-mecanica-cinematica-e-leis-de-newton';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'fisica-mecanica-trabalho-energia-e-potencia';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'fisica-mecanica-estatica-e-equilibrio-base-para-biomecanica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'matematica-fundamentos-funcoes-e-interpretacao-de-graficos';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'matematica-fundamentos-nocoes-de-calculo-derivadas-e-integrais-basicas';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'matematica-fundamentos-estatistica-descritiva-media-mediana-desvio-padrao';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'matematica-fundamentos-probabilidade-basica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'matematica-fundamentos-interpretacao-de-dados-e-graficos-bioestatistica';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'outras-anatomia-humana-introducao-terminologia-anatomica-planos-eixos-posicoes';
UPDATE topics SET content = '## Essencial
...
' WHERE id = 'outras-anatomia-humana-introducao-visao-geral-dos-sistemas-do-corpo-humano';
